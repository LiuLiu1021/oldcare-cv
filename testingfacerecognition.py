# -*- coding: utf-8 -*-
'''
测试人脸识别模型-默认使用hog，识别是谁

用法：
python /home/reed/Desktop/code/oldcare/testingfacerecognition.py
python /home/reed/Desktop/code/oldcare/testingfacerecognition.py --filename room_01.mp4
'''
